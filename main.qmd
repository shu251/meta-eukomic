...
Necessary flags for retaining the non-rRNA aligned reads and outputting them as separate R1 and R2 files: `-fastx`, `--paired_in`, and `--out2`.


To learn more about this check out this thread: _How do I properly run sortmerna?_ https://github.com/sortmerna/sortmerna/issues/333
